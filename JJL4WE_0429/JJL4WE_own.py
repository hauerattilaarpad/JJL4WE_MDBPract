...
# Új adatbázis a repülőtérnek
db = client["RepterDB"]

# Gyűjtemények (Collection) létrehozása
jarat_coll = db["jarat"]
utas_coll = db["utas"]

# Kezdeti takarítás (hogy ne legyenek duplikációk az ismételt futtatáskor)
...
utasok_adatok = [
    {
        "_id": "98765432",        # Útlevélszám lesz az elsődleges kulcs
        "jarat_id": "113",        # Hivatkozás a járatra
        "jegy_id": "1113",
        "nev": "Hauer Attila",
        "szuletesi_ev": 2002,
        "nem": "Férfi",
